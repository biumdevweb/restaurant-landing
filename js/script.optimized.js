...
// Lazy loading per Google Maps
function loadGoogleMaps() {
  if (!mapContainer || mapContainer.dataset.loaded === 'true') return;
  
  mapContainer.innerHTML = `
    <iframe
      src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2970.248936398018!2d12.47639791544112!3d41.90278377922044!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x132f60b9b9b9b9b9%3A0x9b9b9b9b9b9b9b9b!2sVia%20del%20Corso%2C%20123%2C%2000186%20Roma%20RM!5e0!3m2!1sit!2sit!4v1234567890"
      allowfullscreen=""
      loading="lazy"
      referrerpolicy="no-referrer-when-downgrade"
      title="Mappa di Osteria della Tradizione">
    </iframe>
  `;
...
// Event listener per il pulsante di caricamento mappa
if (loadMapBtn) {
  loadMapBtn.addEventListener('click', loadGoogleMaps);
}

// Intersection Observer per caricare la mappa quando diventa visibile
...
// Scroll animations con performance ottimizzata
...
// Header background on scroll - ottimizzato con throttling per performance
let scrollTimeout;
...
// Add active class to navigation based on scroll position - ottimizzato con throttling
...
window.addEventListener('scroll', () => {
  ...
  navScrollTimeout = window.requestAnimationFrame(() => {
    let current = '';
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Handle keyboard navigation for gallery - ottimizzato con listener passivo
  ...
  // Pause gallery auto-play when page is not visible - ottimizzato con listener passivo
